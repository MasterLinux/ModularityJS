...
export var NamespaceUtility = {
     ...
     */
    create: function (parent, namespaceParts) {
     ...
     */
    extend: function(parent, namespaceParts, extensionName, extension) {
        let namespace = this.create(parent, namespaceParts);
